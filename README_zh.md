...
| **Isaac Sim 仿真** | ⏳ 计划中 | 导入USD模型并实现仿真遥操作 | [DLI Course](https://www.seeedstudio.com/sim-to-real-with-seeed-rebot-and-nvidia-isaac) and [源代码](https://github.com/Seeed-Projects/reBot-Isaacsim)|
| **逐步更新最新算法** | ⏳ 计划中 | 逐步更新主流算法 | 持续进行 |
| **推出系列完全免费课程** | ⏳ 计划中 | 逐步更新主流算法 | 持续进行 |
